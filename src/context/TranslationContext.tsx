...
const DICT: Dict = {
  ...
  pt: {
    ...
    acceptOffer: "Aceitar",
    modifyOffer: "Modificar proposta",
    refuseOffer: "Recusar",
    ...
    requestRefused: "Pedido foi recusado.",
    requestRefuseErr: "Não foi possível recusar o pedido.",
    filterPending: "Ausstehend",
    filterValidated: "Bestätigt",
    filterCanceled: "Abgelehnt",
    confirmTitle: "Aktion bestätigen",
    confirmDesc: "Bitte bestätige deine Auswahl.",
    confirmOk: "Bestätigen",
    confirmAcceptOffer: "Dieses Angebot akzeptieren?",
    confirmRejectOffer: "Dieses Angebot ablehnen?",
    confirmRejectRequest: "Diese Anfrage ablehnen?",
    confirmDeleteRequest: "Diese Anfrage endgültig löschen?",
    deleted: "Gelöscht",
    requestDeleted: "Anfrage wurde endgültig gelöscht.",
    requestDeleteErr: "Anfrage konnte nicht gelöscht werden.",
  },
};
